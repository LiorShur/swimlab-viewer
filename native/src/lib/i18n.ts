...
export const STR: Record<Lang, Record<string, string>> = {
  en: {
    ...
    histScreenTitle: "Your swims", histOpenFail: "Couldn't open that swim.",
    statSwims: "Swims", statDistance: "Distance", statLengths: "Lengths", statSince: "Since",
    ...
    shStyle: "Style", shPool: "Pool", shDistance: "Distance", shLengths: "Lengths",
    shStrokes: "Strokes", shPace: "Pace", shTempo: "Tempo", styleFreestyle: "Front crawl",
    shToday: "Today",
    ...
    detBreaths: "Breath-by-breath", detLengths: "Length-by-length", detArms: "Per-arm detail",
    detSymmetry: "Left / right symmetry", detGate: "Breath pattern",
    thSide: "Side", thDpitch: "Δpitch", thPeakRoll: "Peak roll", thDur: "Dur", thLen: "#",
    thStrokes: "Strokes", thTime: "Time", thArm: "Arm", thRate: "Rate", thAmp: "Amplitude",
    thPull: "Pull", excludedTag: "excl", gateLabel: "gate", rollSym: "Peak roll", ampSym: "Pull amplitude",
    phaseLabel: "Arm phase offset", phaseAnti: "0.5 = antiphase (ideal)",
  ...
  he: {
    ...
    histScreenTitle: "השחיות שלך", histOpenFail: "לא ניתן לפתוח את השחייה.",
    statSwims: "שחיות", statDistance: "מרחק", statLengths: "אורכים", statSince: "מאז",
    ...
    shStyle: "סגנון", shPool: "בריכה", shDistance: "מרחק", shLengths: "אורכים",
    shStrokes: "תנועות", shPace: "קצב", shTempo: "טמפו", styleFreestyle: "חתירה",
    shToday: "היום",
    ...
    detBreaths: "נשימה אחר נשימה", detLengths: "אורך אחר אורך", detArms: "פירוט לכל יד",
    detSymmetry: "סימטריית ימין / שמאל", detGate: "דפוס נשימה",
    thSide: "צד", thDpitch: "Δפיץ׳", thPeakRoll: "שיא סיבוב", thDur: "משך", thLen: "#",
    thStrokes: "תנועות", thTime: "זמן", thArm: "יד", thRate: "קצב", thAmp: "טווח",
    thPull: "משיכה", excludedTag: "מוחרג", gateLabel: "סף", rollSym: "שיא סיבוב", ampSym: "טווח משיכה",
    phaseLabel: "הפרש פאזה בין הידיים", phaseAnti: "0.5 = אנטי-פאזה (אידיאלי)",
